...
| -------------------- | -------------------------------- | ------------------------------------------------------- | ----------------------------------------------------- |
| **PlayHT**           | Large voice library, low latency | 900+ voices, <600ms latency, ultra-realistic            | [play.ht](https://play.ht/)                           |
...
| **OpenAI TTS**     | Good      | No                  | 13+       | ~600ms  | $0.015-0.030       |
| **Cartesia Sonic** | Very good | No                  | 15+       | ~40ms   | ~$0.03/min         |
| **PlayHT**         | Very good | Yes                 | 140+      | <600ms  | ~$0.10-0.20        |
| **Fish Audio**     | Good      | Yes                 | 13+       | ~200ms  | ~$0.05-0.10        |
| **WellSaid**       | Very good | No (actor voices)   | English   | ~600ms  | Custom pricing     |
